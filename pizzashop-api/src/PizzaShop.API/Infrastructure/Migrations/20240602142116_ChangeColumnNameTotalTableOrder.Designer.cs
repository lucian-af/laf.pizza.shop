...
namespace PizzaShop.API.Infrastructure.Migrations
{
    ...
    [Migration("20240602142116_ChangeColumnNameTotalTableOrder")]
    partial class ChangeColumnNameTotalTableOrder
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PizzaShop.API.Domain.Entities.Orders.Order", b =>
                {
                    ...
                    b.ToTable("orders", null, t =>
                        {
                            t.HasCheckConstraint("CK_Order_Status", "status in ('pending', 'processing', 'delivering', 'delivered', 'canceled')");
                        });
                });
